...
<%
  ...
  WebForm PachettoTraInvioForm =  
     new com.thera.thermfw.web.WebFormForBatchForm(request, response, "PachettoTraInvioForm", "PachettoTraInvio", "Arial,10", "com.thera.thermfw.batch.web.BatchFormActionAdapter", false, false, false, true, true, true, null, 0, true, "it/softre/thip/archismall/trasmissione/web/PacchettoTrasmissioneInvio.js"); 
