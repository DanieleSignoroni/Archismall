...
<%
  ...
  WebForm PacchettoInviatoForm =  
     new com.thera.thermfw.web.WebForm(request, response, "PacchettoInviatoForm", "PacchettoInviato", null, "com.thera.thermfw.web.servlet.FormActionAdapter", false, false, true, true, true, true, null, 1, true, "it/softre/thip/archismall/trasmissione/PacchettoInviato.js"); 
