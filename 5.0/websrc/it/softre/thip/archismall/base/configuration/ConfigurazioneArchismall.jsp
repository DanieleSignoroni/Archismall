   ...
   <tr>
     <td height="100%"><div class="tabbed_pagine" id="tabbedPagine" style="position: relative; width: 100%; height: 100%;"> <div class="tabbed_page" id="<%=mytabbed.getTabPageId("tab1")%>" style="width:100%;height:100%;overflow:auto;"><% mytabbed.startTab("tab1"); %>
							<table style="width: 100%;">
								<tr>
									<td valign="top"><%{  WebLabelCompound label = new com.thera.thermfw.web.WebLabelCompound(null, null, "ConfigurazioneArchismall", "Url", null); 
   label.setParent(ConfigurazioneArchismallForm); 
%><label class="<%=label.getClassType()%>" for="Url"><%label.write(out);%></label><%}%></td>
									<td valign="top"><% 
...
%>
								...
								<tr>
									<td valign="top"><%{  WebLabelCompound label = new com.thera.thermfw.web.WebLabelCompound(null, null, "ConfigurazioneArchismall", "ClientSecret", null); 
   label.setParent(ConfigurazioneArchismallForm); 
%><label class="<%=label.getClassType()%>" for="ClientSecret"><%label.write(out);%></label><%}%></td>
									<td valign="top"><% 
...
%>
								...
								<tr>
									<td valign="top"><%{  WebLabelCompound label = new com.thera.thermfw.web.WebLabelCompound(null, null, "ConfigurazioneArchismall", "ClientId", null); 
   label.setParent(ConfigurazioneArchismallForm); 
%><label class="<%=label.getClassType()%>" for="ClientId"><%label.write(out);%></label><%}%></td>
									<td valign="top"><% 
...
%>
								...
								<tr>
									<td valign="top"><%{  WebLabelCompound label = new com.thera.thermfw.web.WebLabelCompound(null, null, "ConfigurazioneArchismall", "IdUtente", null); 
   label.setParent(ConfigurazioneArchismallForm); 
%><label class="<%=label.getClassType()%>" for="IdUtente"><%label.write(out);%></label><%}%></td>
									<td valign="top"><% 
...
%>
								...
								<tr>
									<td valign="top"><%{  WebLabelCompound label = new com.thera.thermfw.web.WebLabelCompound(null, null, "ConfigurazioneArchismall", "Password", null); 
   label.setParent(ConfigurazioneArchismallForm); 
%><label class="<%=label.getClassType()%>" for="Password"><%label.write(out);%></label><%}%></td>
									<td valign="top"><% 
...
%>
								...
								<tr>
									<td valign="top"><%{  WebLabelCompound label = new com.thera.thermfw.web.WebLabelCompound(null, null, "ConfigurazioneArchismall", "PartitaIva", null); 
   label.setParent(ConfigurazioneArchismallForm); 
%><label class="<%=label.getClassType()%>" for="PartitaIva"><%label.write(out);%></label><%}%></td>
									<td valign="top"><% 
  WebTextInput ConfigurazioneArchismallPartitaIva =  
     new com.thera.thermfw.web.WebTextInput("ConfigurazioneArchismall", "PartitaIva"); 
  ConfigurazioneArchismallPartitaIva.setParent(ConfigurazioneArchismallForm); 
%>
<input class="<%=ConfigurazioneArchismallPartitaIva.getClassType()%>" id="<%=ConfigurazioneArchismallPartitaIva.getId()%>" maxlength="<%=ConfigurazioneArchismallPartitaIva.getMaxLength()%>" name="<%=ConfigurazioneArchismallPartitaIva.getName()%>" size="<%=ConfigurazioneArchismallPartitaIva.getSize()%>"><% 
  ConfigurazioneArchismallPartitaIva.write(out); 
%>
