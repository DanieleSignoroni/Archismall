...
import com.thera.thermfw.base.Crypto3;
...
public class BaseArchismallApi {
	...
	public void setConfigurazioneArchismall(ConfigurazioneArchismall c) {
		this.configurazioneArchismall = c;
	}
	 ...
	 */
	protected void init() {
		setConfigurazioneArchismall(ConfigurazioneArchismall.getConfigurazioneArchismall());
	}
	...
	private String getBaseParametersForAuthentication(String grantType) {
		String parameters = "";
		if(getConfigurazioneArchismall() != null) {
			String pwd = getConfigurazioneArchismall().getPassword();
			try {
				pwd = Crypto3.decryptDenied(pwd);
